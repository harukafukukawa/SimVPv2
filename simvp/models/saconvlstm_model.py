...
from simvp.modules import SAConvLSTMCell



class SAConvLSTM_Model(nn.Module):
    r"""SAConvLSTM Model
    ...
    def __init__(self, num_layers, num_hidden, configs, **kwargs):
        super(SAConvLSTM_Model, self).__init__()
        ...
        for i in range(num_layers):
            ...
            cell_list.append(
                SAConvLSTMCell(in_channel, num_hidden[i], height, width, configs.filter_size,
                                       configs.stride, configs.layer_norm, configs.d_attn)
            )
